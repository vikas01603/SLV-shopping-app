...
import { FaUserPlus, FaTrash, FaShieldAlt, FaEnvelope, FaUser } from "react-icons/fa";
                                    ...
                                    <td className="py-6 px-10 text-xs">
                                        <div className="flex items-center gap-3">
                                             ...
                                             <select value={u.role} onChange={(e) => handleRoleChange(u._id, e.target.value)} 
                                                className={`text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full border border-transparent outline-none cursor-pointer transition-all ${
                                                    u.role === 'admin' 
                                                    ? 'bg-black text-white' 
