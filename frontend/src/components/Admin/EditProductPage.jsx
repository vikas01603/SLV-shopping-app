...
import { FaCloudUploadAlt, FaTimes, FaSave, FaArrowLeft } from "react-icons/fa";
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between px-2">
                <div>
                    <h2 className="text-3xl font-bold text-black tracking-tight">Edit Product</h2>
                    <p className="text-gray-400 text-sm font-medium mt-1 uppercase tracking-widest">
                        Updating details and specifications of the products
                    </p>
                </div>
                <button 
                    onClick={() => navigate('/admin/products')}
                    className="p-4 bg-gray-50 text-gray-400 rounded-2xl hover:bg-black hover:text-white transition-all shadow-sm flex items-center gap-2"
                >
                    <FaArrowLeft size={14} /> <span className="text-xs font-bold uppercase tracking-widest hidden md:inline">Catalog</span>
                </button>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 md:p-14 relative overflow-hidden">
                ...
                {error && <div className="mb-8 p-4 bg-red-50 border border-red-100 rounded-2xl text-red-600 font-medium">{error.message || error}</div>}
                ...
                <form onSubmit={handleSubmit} className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6 md:col-span-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea name="description" value={productData.description} onChange={handleChange}
                                ...
                                rows={4} placeholder="Describe the item..." required />
                        </div>
                    </div>
                    ...
                    {/* Variations */}
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Size (Comma Seperated)</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Color (Comma Seperated)</label>
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" name="collections" value={productData.collections} onChange={handleChange}
                            className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-black transition-all font-bold text-sm"
                            placeholder="e.g. Winter 2026" required />
                    </div>
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Gender Target</label>
                    ...
                    <div className="md:col-span-2 space-y-6 pt-4 border-t border-gray-50 mt-4">
                        <div className="flex flex-col items-center justify-center p-12 bg-gray-50 border-2 border-dashed border-gray-100 rounded-[2rem] group hover:border-black/20 hover:bg-neutral-50 transition-all relative">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="font-bold text-black italic">Upload Images</span>
                                <span className="text-[10px] text-gray-400 uppercase tracking-widest mt-1">Remove or Add Product related Images</span>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-6">
                            {productData.images.map((image, index) => (
                                <motion.div 
                                    ...
                                    key={index} 
                                    className="relative group aspect-square rounded-2xl overflow-hidden shadow-sm border border-gray-50"
                                >
                                    ...
                                    <button
                                        ...
                                        className="absolute top-2 right-2 bg-black/80 backdrop-blur-md text-white rounded-full p-2 text-[8px] opacity-0 group-hover:opacity-100 transition-opacity"
                                    ><FaTimes /></button>
                                </motion.div>
                            ))}
                        </div>
                    ...
                    <div className="md:col-span-2 pt-10 flex justify-center">
                        ...
                        >
                           <FaSave size={14} /> {loading ? "Updating Registry..." : "Update Product"} 
                        </button>
                    </div>
                </form>
            </div>
